  ...
  Widget build(BuildContext context) {
    ...
    void login(){
      ...
      if(form.validate()) {
        ...
        autovalid=true;
        showMessage('Data is not valid',Colors.red);
      }
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: new Row(
                        children: <Widget>[
                          Expanded(
                              child: Text("Mobile Banking",textAlign: TextAlign.center,style:TextStyle(fontSize: 34,color: Colors.redAccent,fontFamily:'mukta'),)
                          )
                        ],),),
